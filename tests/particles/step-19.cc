...
namespace Step19
{
  ...
  template <int dim>
  void
  CathodeRaySimulator<dim>::assemble_system()
  {
    system_matrix = 0;
    system_rhs    = 0;
  ...
  template <int dim>
  void
  CathodeRaySimulator<dim>::solve_field()
  {
  ...
  template <int dim>
  void
  CathodeRaySimulator<dim>::refine_grid()
  {
  ...
  template <int dim>
  void
  CathodeRaySimulator<dim>::create_particles()
  {
  ...
  template <int dim>
  void
  CathodeRaySimulator<dim>::move_particles()
  {
  ...
  template <int dim>
  void
  CathodeRaySimulator<dim>::update_timestep_size()
  {
