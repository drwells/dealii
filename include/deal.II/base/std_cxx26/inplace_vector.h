...
#  endif
     ...
     * compatibility with other containers but, since this vector contains its
     * own storage, it does not effect the vector in any way.
     */
    ...
    /**
     * Destruct the last object in the vector.
     */
    void
    pop_back()
    {
